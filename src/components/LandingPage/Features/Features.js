    ...
    return (
        ...
        >
            ...
            <Container maxWidth={'lg'}>
                <Grid container spacing={3} sx={{my: 4}} className="grid-container">
                    ...
                    <Grid item xs={12} sm={6} md={4} className="grid-item">
                        <FeatureCard
                            title="AI Caption & Hashtag Suggestions"
                            description="Boost your visibility with AI-selected hashtags & captions."
                        />
                        <FeatureCard
                            title="Speech to Text"
                            description="Get AI to transform your voice into text!"
                        />
                    </Grid>
                    <Grid item xs={12} sm={6} md={4} className="grid-item">
                        <FeatureCard
                            title="Social Media AI Expert"
                            description="Speak with our expert to create the best posts!"
                        />
                        <FeatureCard
                            title="AI Voiceover"
                            description="Allow AI to story tell your content!"
                        />
                    </Grid>
                </Grid>
            </Container>
